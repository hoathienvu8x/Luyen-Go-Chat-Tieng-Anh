...
namespace {
    ...
    JSON parse_object( const string &str, size_t &offset ) {
        ...
        while( true ) {
            ...
            if( str[offset] != ':' ) {
                #ifdef DEBUG
                std::cerr << "Error: Object: Expected colon, found '" << str[offset] << "' [" << str << "]\n";
                #endif
                break;
            }
            consume_ws( str, ++offset );
            ...
            if( str[offset] == ',' ) {
                ...
                #ifdef DEBUG
                std::cerr << "ERROR: Object: Expected comma, found '" << str[offset] << "' [" << str << "]\n";
                #endif
                break;
            }
        }
    ...
    JSON parse_array( const string &str, size_t &offset ) {
        ...
        while( true ) {
            ...
            if( str[offset] == ',' ) {
                ...
                #ifdef DEBUG
                std::cerr << "ERROR: Array: Expected ',' or ']', found '" << str[offset] << "' [" << str << "]\n";
                #endif
                return std::move( JSON::Make( JSON::Class::Array ) );
            }
        }
